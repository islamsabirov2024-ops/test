...
async def add_movie_4(m:Message, state:FSMContext):
    ...
    premium=1 if ('ha' in txt or txt in {'1','yes'}) else 0
...
async def add_ch1(m:Message,state:FSMContext):
    ...
    if checkable:
        ...
        return await m.answer(
            ...
            '🔹 2. Havola orqali ulash\nKanal/guruh havolasini yuboring. Masalan: @kanal_nomi yoki https://t.me/kanal\n\n'
    ...
    return await m.answer('🔗 Havola kiriting:\n\nMasalan: https://site.com yoki https://t.me/kanal', reply_markup=rkb([['◀️ Orqaga']]))
...
async def pay_panel(m:Message):
    ...
    txt='💳 To‘lov tizimlari: '+str(len(rows))+' ta'
    if rows:

...
class BotManager:
    ...
    async def _start_kino_full(self, row: dict):
        ...
        # Kino bot to‘liq tayyor zipdagi python-telegram-bot kod bilan alohida child process bo‘lib ishlaydi.
        proc = await asyncio.create_subprocess_exec(
            sys.executable,
            'bot.py',
            cwd=str(KINO_TEMPLATE),
            env=env,
        ...
        return True, 'To‘liq kino bot child process sifatida ishga tushirildi.'

...
async def _show_settings_menu(update: Update) -> None:
    ...
    subscription_fake_verify = await db.get_setting("subscription_fake_verify", "0")
    ...
    kb = InlineKeyboardMarkup([
        ...
        [
            InlineKeyboardButton("👥 Referral", callback_data="admin_referral_settings"),
...
async def admin_callback_handler(update: Update, context: ContextTypes.DEFAULT_TYPE) -> bool:
    ...
    if data == "admin_toggle_fake_verify":
        current = await db.get_setting("subscription_fake_verify", "0")

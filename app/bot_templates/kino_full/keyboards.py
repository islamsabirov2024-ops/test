...
def admin_movie_edit_kb(code: str, is_premium: int):
    return InlineKeyboardMarkup([
        _one("✏️ Kodini o‘zgartirish", f"edit_movie_code:{code}"),
        _one("✏️ Nomini o‘zgartirish", f"edit_movie_name:{code}"),
        _one("✏️ Ma’lumotini o‘zgartirish", f"edit_movie_caption:{code}"),
        _one("💎 Premiumni almashtirish", f"toggle_movie_access:{code}"),
        _one("🔙 Orqaga", "admin_movies_menu"),
    ])

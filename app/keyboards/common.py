...
def movie_admin() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text='📺 Kino kanal', callback_data='m:storage')],
        ...
        [InlineKeyboardButton(text='🧹 Keshni tozalash', callback_data='m:cache')],
...
# Reklama tozalovchi bot ichki menyusi
# ad_cleaner.py shu funksiyani import qiladi.
def ad_cleaner_menu() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text='🧹 Tozalash yoqilgan', callback_data='ad:menu')],
    ])

# Invite bot ichki menyusi
# invite_gate.py shu funksiyani import qiladi.

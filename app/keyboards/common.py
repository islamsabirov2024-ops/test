...
def manage_bot(bot_id: int, active: bool = False) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text=BACK, callback_data=f'menu:my_bots'), InlineKeyboardButton(text="🗑 O'chirish", callback_data=f'delete:{bot_id}')],
    ])
...
# ===================== KINO BOT UI =====================
def movie_admin_reply() -> ReplyKeyboardMarkup:
    return ReplyKeyboardMarkup(
        keyboard=[
            [KeyboardButton(text='📊 Statistika'), KeyboardButton(text='🎬 Kinolar')],
            [KeyboardButton(text='🔐 Kanallar'), KeyboardButton(text='📺 Kino kanal')],
            [KeyboardButton(text='🎬 Kino qo‘shish'), KeyboardButton(text='🗑 Kino o‘chirish')],
            [KeyboardButton(text='⭐ Premium'), KeyboardButton(text='⚙️ Sozlamalar')],
            [KeyboardButton(text='👮 Adminlar'), KeyboardButton(text='📨 Xabar yuborish')],
            [KeyboardButton(text='🧹 Keshni tozalash'), KeyboardButton(text='📚 Qo‘llanma')],
        ],
        resize_keyboard=True,
        input_field_placeholder='Kino bot admin menyu',
    )


def movie_admin() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text='🎬 Kino qo‘shish', callback_data='m:add'), InlineKeyboardButton(text='📺 Kino kanal', callback_data='m:storage')],
        [InlineKeyboardButton(text='📋 Kinolar ro‘yxati', callback_data='m:list'), InlineKeyboardButton(text='🔐 Premium', callback_data='m:premium')],
        [InlineKeyboardButton(text='📢 Majburiy obuna', callback_data='m:channels'), InlineKeyboardButton(text='📊 Statistika', callback_data='m:stats')],
        [InlineKeyboardButton(text='🧹 Keshni tozalash', callback_data='m:cache'), InlineKeyboardButton(text='📚 Qo‘llanma', callback_data='m:help')],
        [InlineKeyboardButton(text='🗑 Kino o‘chirish', callback_data='m:del')],
        [InlineKeyboardButton(text='◀️ Orqaga', callback_data='m:back')],
    ])


def movie_channel_menu() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text='➕ Kanal qo‘shish / almashtirish', callback_data='m:storage_add')],
        [InlineKeyboardButton(text='📋 Kanal holati', callback_data='m:storage')],
        [InlineKeyboardButton(text='🧹 Kanal sozlamasini tozalash', callback_data='m:storage_clear')],
        [InlineKeyboardButton(text='◀️ Orqaga', callback_data='m:back')],
    ])


# ===================== REKLAMA TOZALOVCHI UI =====================
def ad_cleaner_reply() -> ReplyKeyboardMarkup:
    return ReplyKeyboardMarkup(
        keyboard=[
            [KeyboardButton(text='✅ Status'), KeyboardButton(text='⚙️ Sozlamalar')],
            [KeyboardButton(text='🚫 Blacklist'), KeyboardButton(text='🧾 Tozalash logi')],
            [KeyboardButton(text='🧪 Test'), KeyboardButton(text='🧹 Keshni tozalash')],
            [KeyboardButton(text='📚 Qo‘llanma'), KeyboardButton(text='◀️ Orqaga')],
        ],
        resize_keyboard=True,
        input_field_placeholder='Qorovul bot menyu',
    )


def ad_cleaner_menu() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text='✅ Status', callback_data='ad:status')],
        [InlineKeyboardButton(text='⚙️ Sozlamalar', callback_data='ad:settings')],
        [InlineKeyboardButton(text='🚫 Blacklist', callback_data='ad:blacklist'), InlineKeyboardButton(text='🧾 Tozalash logi', callback_data='ad:log')],
        [InlineKeyboardButton(text='🧪 Test', callback_data='ad:test'), InlineKeyboardButton(text='🧹 Keshni tozalash', callback_data='ad:cache')],
        [InlineKeyboardButton(text='📚 Qo‘llanma', callback_data='ad:help')],
    ])
...
def ad_settings_menu(settings: dict | None = None) -> InlineKeyboardMarkup:
    s = settings or {}
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text=f'{_onoff(s.get("clean_links", True))} Ssilkalar', callback_data='ad:toggle:clean_links'), InlineKeyboardButton(text=f'{_onoff(s.get("clean_mentions", True))} @kanal', callback_data='ad:toggle:clean_mentions')],
        [InlineKeyboardButton(text=f'{_onoff(s.get("clean_forwards", True))} Forward', callback_data='ad:toggle:clean_forwards'), InlineKeyboardButton(text=f'{_onoff(s.get("clean_spam", True))} Spam so‘zlar', callback_data='ad:toggle:clean_spam')],
        [InlineKeyboardButton(text=f'{_onoff(s.get("clean_buttons", True))} URL tugmalar', callback_data='ad:toggle:clean_buttons'), InlineKeyboardButton(text=f'{_onoff(s.get("ignore_admins", True))} Adminlarga tegmasin', callback_data='ad:toggle:ignore_admins')],
        [InlineKeyboardButton(text=f'{_onoff(s.get("warn_enabled", True))} Ogohlantirish', callback_data='ad:toggle:warn_enabled')],
        [InlineKeyboardButton(text='◀️ Orqaga', callback_data='ad:menu')],
    ])
...
def invite_menu() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text='📊 Statistika', callback_data='inv:stats')],
        [InlineKeyboardButton(text='📚 Qo‘llanma', callback_data='inv:help')],
        [InlineKeyboardButton(text='👥 Invite menyu', callback_data='inv:menu')],
    ])

# Qo'shimcha kino menyulari (rasmdagi kabi tugmali bo'limlar)
def movie_section_menu() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text='➕ Kino qo‘shish', callback_data='m:add'), InlineKeyboardButton(text='✏️ Kino tahrirlash', callback_data='m:list')],
        [InlineKeyboardButton(text='🗑 Kino o‘chirish', callback_data='m:del')],
        [InlineKeyboardButton(text='◀️ Orqaga', callback_data='m:back')],
    ])


def movie_add_method_menu() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text='📨 Forward qilingan post', callback_data='m:addinfo:forward'), InlineKeyboardButton(text='🔗 Post ssilkasi', callback_data='m:addinfo:link')],
        [InlineKeyboardButton(text='📁 Botga kino yuborish', callback_data='m:addinfo:file'), InlineKeyboardButton(text='🌐 Tashqi ssilka qo‘shish', callback_data='m:addinfo:external')],
        [InlineKeyboardButton(text='◀️ Orqaga', callback_data='m:back')],
    ])
